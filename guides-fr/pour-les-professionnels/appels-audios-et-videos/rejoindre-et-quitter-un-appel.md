...
{% stepper %}
{% step %}
**Lors de la réception d'un appel conférence, votre mobile ou votre tablette sonnera. Cliquez sur&#x20;**_**Accepter**_**.**

<div align="left"><figure><img src="../../.gitbook/assets/CleanShot 2026-01-21 at 13.48.44@2x.png" alt="" width="311"><figcaption></figcaption></figure></div>
{% endstep %}

{% step %}
**Pour quitter la réunion, cliquez sur le téléphone rouge.**

<div align="left"><figure><img src="../../.gitbook/assets/CleanShot 2026-01-21 at 13.49.27@2x.png" alt="" width="313"><figcaption></figcaption></figure></div>
{% endstep %}
{% endstepper %}
{% endtab %}
